<%-- 
    Document   : shop
    Created on : 15 Aug 2025, 12:34:05
    Author     : Bavi2
--%>
...
<body>
  ...
  <main class="book-grid">
    ...
    <div class="book-card">
      ...
      <img src="https://covers.openlibrary.org/b/id/10524855-L.jpg" alt="Book Cover">
      <h3>Historical Fantasy</h3>
      <p>Steven Heller</p>
      <p class="price"><span class="original">433.90</span> <span class="discounted">422.22</span></p>
    </div>

    <!-- Duplicate and update these blocks for more books -->
    <!-- Book 2 -->
