<%-- 
    ...
    Created on : 15 Aug 2025, 12:44:48
    Author     : Bavi2
--%>
...
<body>
    <div class="container">
        ...
        <form id="customerForm">
			...
			<label for="id">Customer Id</label>
                <input type="text" id="id" placeholder="Enter your cusId" required>
    ...
    <script>
        document.getElementById('customerForm').addEventListener('submit', function (e) {
            ...
            if (!name || !accountNumber || !address || !email || !phone || !registrationDate || !password) {
            ...
            document.getElementById('messageBox').textContent = 'Customer account successfully added!';
